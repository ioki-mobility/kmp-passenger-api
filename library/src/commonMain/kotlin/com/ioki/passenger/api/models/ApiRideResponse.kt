...
public data class ApiRideResponse(
    ...
    @SerialName(value = "available_booking_payment_method_types") val availableBookingPaymentMethodTypes: List<ApiPaymentMethodType>?,
    @SerialName(value = "available_tip_payment_method_types") val availableTipPaymentMethodTypes: List<ApiPaymentMethodType>?,
) : Entity {
    @Serializable
